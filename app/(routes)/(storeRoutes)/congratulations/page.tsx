...
export default function Congratulations() {
    ...
    useEffect(() => {
        clearCart(); // Garante que o carrinho seja limpo após a montagem do componente
    }, [clearCart]);
    ...
    return (
        <div className="flex flex-col items-center mt-5 px-4">
            ...
            <p className="text-sm text-gray-600 text-center">
                Olá, {client}. Obrigado por comprar na {store}. Em alguns minutos entraremos em contato pra confirmar seu pedido. Então fique atento.
            </p>
            ...
            <div className="flex items-center mt-5 mb-2 gap-4">
                ...
                <Link href={`https://api.whatsapp.com/send?phone=55${cleanNumber}`} className="text-primary">
                    Entrar em contato
                </Link>
            </div>
